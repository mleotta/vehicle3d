// This is dml/dml_proj_cost_func.cxx
...
void
dml_proj_cost_func::set_errors(const vil_image_view<float>& e)
{
...
//: The main function.
double
dml_proj_cost_func::f(vnl_vector<double> const& x)
{
...
//: The main function.
double
dml_motion_cost_func::f(vnl_vector<double> const& x)
{
  double error = 0.0;
