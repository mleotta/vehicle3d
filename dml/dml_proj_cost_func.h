// This is dml/dml_proj_cost_func.h
#ifndef dml_proj_cost_func_h_
#define dml_proj_cost_func_h_
//:
// \file
...
class dml_proj_cost_func : public vnl_cost_function
{
public:
  //: Constructor
  dml_proj_cost_func( const vil_image_view<float>& errors,
...
class dml_motion_cost_func : public vnl_cost_function
{
public:
  //: Constructor
  dml_motion_cost_func( const vcl_vector<vil_image_view<float> >& errors,
                        const vnl_double_3x4& camera,
                        const vpgl_poly_radial_distortion<double,4>& lens,
                        const imesh_mesh& model,
                        double xs, double ys );
...
protected:
  ...
  dml_proj_cost_func frame_cost_;
