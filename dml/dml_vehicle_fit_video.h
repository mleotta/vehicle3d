// This is dml/dml_vehicle_fit_video.h
#ifndef dml_vehicle_fit_video_h_
#define dml_vehicle_fit_video_h_
//=========================================================================
//:
// \file
...
class dml_vehicle_fit_video : public dml_vehicle_fit
{
public:
  
  //: Constructor
  dml_vehicle_fit_video();
  ...
  const dml_pca_vehicle_projector& projector() const;
  
  //: Apply fitting to correct the predicted state
  bool correct_state(dml_vehicle_state& state);
  ...
  dml_vehicle_tracker& tracker() { return tracker_; }
...
private:
  ...
  void set_priors_from_track(const dml_vehicle_state& state);
  ...
  void update_posterior_covariance(const dml_pca_vehicle& mesh,
