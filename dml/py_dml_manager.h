// This is dml/py_dml_manager.h
#ifndef py_dml_manager_h_
#define py_dml_manager_h_
//----------------------------------------------------------------------------
//:
// \file
...
public:
  ...
  const vcl_vector<dml_vehicle_state>& get_vehicle_states() const;
...
private:
  ...
  static py_dml_manager *instance_;
  ...
  vcl_vector<dml_vehicle_state> vehicle_states_;
