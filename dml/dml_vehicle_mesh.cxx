// This is dml/dml_vehicle_mesh.cxx
                          ...
                          imesh_mesh& mesh)
{
  ...
  vcl_auto_ptr<imesh_vertex_array_base> verts(dml_generate_vehicle_wheel_verts(r1,r2,ww));
  vcl_auto_ptr<imesh_face_array_base> faces(dml_generate_vehicle_wheel_faces());
  vcl_vector<vgl_point_2d<double> > texture(dml_generate_vehicle_wheel_tex());
  ...
  wheel_mesh_1.set_tex_coords(dml_generate_vehicle_wheel_tex(1));
  wheel_mesh_2.set_tex_coords(dml_generate_vehicle_wheel_tex(2));
  wheel_mesh_3.set_tex_coords(dml_generate_vehicle_wheel_tex(3));
  wheel_mesh_4.set_tex_coords(dml_generate_vehicle_wheel_tex(4));
  ...
  verts = (dml_generate_vehicle_body_verts(params));
  faces = (dml_generate_vehicle_body_faces());

  mesh.set_vertices(verts);
  mesh.set_faces(faces);
  imesh_transform_inplace(mesh,vgl_vector_3d<double>(0,0,r2+so));

  mesh.set_tex_coords(dml_generate_vehicle_body_tex());
...
vcl_auto_ptr<imesh_face_array_base> dml_generate_vehicle_body_faces()
{
...
vcl_auto_ptr<imesh_face_array_base> dml_generate_vehicle_wheel_faces(unsigned int rs)
{
  vcl_auto_ptr<imesh_face_array> faces(new imesh_face_array);
...
vcl_auto_ptr<imesh_vertex_array<3> >
dml_generate_vehicle_wheel_verts(double r1, double r2, double w, unsigned int rs)
{
...
vcl_vector<vgl_point_2d<double> >
dml_generate_vehicle_wheel_tex(unsigned int index, unsigned int rs)
{
                                ...
                                imesh_mesh& mesh)
{
  ...
  vcl_auto_ptr<imesh_vertex_array_base> verts(dml_generate_dodec_vehicle_verts(params));
  vcl_auto_ptr<imesh_face_array_base> faces(dml_generate_dodec_vehicle_faces());
  
  mesh.set_vertices(verts);
  mesh.set_faces(faces);
  imesh_transform_inplace(mesh,vgl_vector_3d<double>(0,0,r2+so));
  
  //mesh.set_tex_coords(dml_generate_dodec_vehicle_tex());
}
                                   ...
                                   imesh_mesh& mesh)
{
  ...
  vcl_auto_ptr<imesh_vertex_array_base> verts(dml_generate_ferryman_vehicle_verts(params));
  vcl_auto_ptr<imesh_face_array_base> faces(dml_generate_ferryman_vehicle_faces());
...
dml_generate_ferryman_vehicle_verts(const vcl_map<vcl_string,double>& params)
{
  ...
  vcl_auto_ptr<imesh_vertex_array<3> > verts_ptr(dml_generate_dodec_vehicle_verts(params));
  imesh_vertex_array<3>& verts = *verts_ptr;
