// This is dml/dml_pca_vehicle.h
#ifndef dml_pca_vehicle_h_
#define dml_pca_vehicle_h_
//=========================================================================
//:
// \file
...
class dml_pca_vehicle : public imesh_pca_mesh
{
public:
  ...
  dml_pca_vehicle(const vcl_vector<imesh_mesh>& meshes,
                  const vcl_vector<part_map>& part_groups);

  //: Constructor 
  dml_pca_vehicle(const imesh_pca_mesh& pca_mesh,
                  const part_map& parts);
  
  //: Constructor from a mesh, parts, mean, standard deviations, and PC matrix
  dml_pca_vehicle(const imesh_mesh& mesh,
                  const part_map& parts,
