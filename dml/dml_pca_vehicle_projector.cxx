...
#include "dml_pca_vehicle_projector.h"
...
dml_pca_vehicle_projector(unsigned int w, unsigned int h)
  : depth_img_(w,h)
{
...
double dml_pca_vehicle_projector::min_depth() const
{
...
double dml_pca_vehicle_projector::max_depth() const
{
...
bool dml_pca_vehicle_projector::
...
void dml_pca_vehicle_projector:: 
map_silhouette(const dml_pca_vehicle& vehicle,
...
vgl_polygon<double> dml_pca_vehicle_projector::silhouette_polygon() const
{
...
void dml_pca_vehicle_projector::
compute_contour_pca_jacobians(const dml_pca_vehicle& vehicle,
...
void dml_pca_vehicle_projector::
compute_parts_pca_jacobians(const dml_pca_vehicle& vehicle,
                            vcl_vector<vnl_matrix_fixed<double,2,3> >::iterator J)
{
...
bool dml_write_svg_curves(const vcl_string& filename,
                          const dml_pca_vehicle_projector& projector)
{
