// This is dml/dml_pca_vehicle.cxx
//=========================================================================
//:
// \file
...
//: Constructor
dml_pca_vehicle::dml_pca_vehicle(const imesh_pca_mesh& pca_mesh,
...
dml_pca_vehicle::dml_pca_vehicle(const imesh_mesh& mesh,
                                 const part_map& parts,
...
dml_pca_vehicle::dml_pca_vehicle(const vcl_vector<imesh_mesh>& meshes,
...
//: Destructor
dml_pca_vehicle::~dml_pca_vehicle()
{
}
...
void dml_pca_vehicle::init(const vnl_vector<double>& mean,
                           const vnl_vector<double>& std_devs,
                           const vnl_matrix<double>& pc)
{
...
vnl_vector<double> 
dml_pca_vehicle::project(const imesh_vertex_array_base& verts, 
...
//: Set the parts
void dml_pca_vehicle::set_parts(const part_map& parts)
{
  parts_ = parts;
...
void dml_pca_vehicle::set_params(const vnl_vector<double>& p)
{
...
// over many calls.
void dml_pca_vehicle::set_param(unsigned int idx, double param)
{
...
void dml_pca_vehicle::pc_to_part_idx(unsigned int pc, 
...
void dml_pca_vehicle::part_to_pc_idx(unsigned int p, unsigned int i, 
...
unsigned int dml_pca_vehicle::part_size(unsigned int p) const
{
...
void dml_pca_vehicle::project_tex_to_bary()
{
...
void dml_pca_vehicle::project_bary_to_3d()
{
  assert(this->has_tex_coords());
...
void dml_pca_vehicle::init_part_idx_offsets()
{
...
void dml_write_pca_vehicle(const vcl_string& mesh_file,
                           const vcl_string& parts_file,
                           const vcl_string& pca_file,
                           const dml_pca_vehicle& pmesh)
{
  ...
  const dml_pca_vehicle::part_map& mparts = pmesh.mean_parts();
  ...
  unsigned int pidx=num_mesh_pts;
  for(dml_pca_vehicle::part_map::const_iterator pitr=mparts.begin(); 
  ...
  dml_write_vehicle_parts(parts_file,mparts);
}
