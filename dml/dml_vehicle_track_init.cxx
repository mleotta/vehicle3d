// This is dml/dml_vehicle_track_init.cxx
//=========================================================================
//:
// \file
...
#include "dml_vehicle_track_init.h"
...
void dml_vehicle_track_init::
set_vehicle(const dml_pca_vehicle& vehicle) 
{
  vehicle_ = vehicle;
...
vgl_vector_3d<double> dml_vehicle_track_init:: 
...
vcl_vector<double> dml_vehicle_track_init::
...
{      
  ...
  for(unsigned int i=0; i<remain_sils.size(); ++i)
  {
    ...
    if(estimate_shape_){
      ...
      if(best_k >= 0){
        states.push_back(dml_vehicle_state(best_p,rotation,translation,5,0,true));
    ...
    // if not estimating shape
      ...
      if(area_ratio > 0.70){
        states.push_back(dml_vehicle_state(vehicle_.params(),rotation,t,5,0,false));
        states.back().silhouette = curr_sil;
      }
    }
  }
