// This is dml/dml_vehicle_fit.cxx
//=========================================================================
//:
// \file
...
//: Constructor
dml_vehicle_fit::dml_vehicle_fit()
: min_e_strength_(0.0),
...
void dml_vehicle_fit::detect_edges(const vil_image_view<vxl_byte>& img,
...
void dml_vehicle_fit::set_options(const vcl_vector<bool>& options, 
                                  unsigned int num_pc)
{
...
void dml_vehicle_fit::set_init_uncert(double uncert)
{ 
                     ...
                     vcl_vector<vnl_vector_fixed<double,3> >& matches) const
{
  ...
  vcl_vector<dml_edgel> edgels =
      dml_find_edgel_neighbors(edge_map,
...
void dml_vehicle_fit::apply_solution(const vnl_vector<double>& soln,
...
void dml_vehicle_fit::fit_model(unsigned int num_itr, 
                                dml_pca_vehicle& mesh,
                                vgl_vector_3d<double>& translation,
                                vgl_rotation_3d<double>& rotation)
{  
...
bool dml_vehicle_fit::fit_model_once(dml_pca_vehicle& mesh,
                                     vgl_vector_3d<double>& translation,
                                     vgl_rotation_3d<double>& rotation,
...
double dml_vehicle_fit::
evaluate_residual(const dml_pca_vehicle& mesh,
...
// This is primarily for debugging
void dml_vehicle_fit::
last_edgel_matches(const dml_pca_vehicle_projector& projector, 
                   const vil_image_view<float>& edge_map,
                   vcl_vector<vgl_point_2d<double> >& edgel_snaps,
                   vcl_vector<vgl_point_2d<double> >& edgels,
                   vcl_vector<double>& edgel_weights) const
...
void dml_vehicle_fit::
last_edgel_coverage(const dml_pca_vehicle_projector& projector, 
                    const vil_image_view<float>& edge_map,
                    double dist_thresh,
