// This is dml/dml_solar_position.h
#ifndef dml_solar_position_h_
#define dml_solar_position_h_
...
void dml_solar_position(int day, double utc_hour,
                        double lat, double lng,
                        double& alt, double& az);



#endif // dml_solar_position_h_
