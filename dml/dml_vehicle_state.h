// This is dml/dml_vehicle_state.h
#ifndef dml_vehicle_state_h_
#define dml_vehicle_state_h_
//=========================================================================
//:
// \file
...
class dml_vehicle_state
{
public:
  dml_vehicle_state()
  : t_velocity(0), a_velocity(0), num_frames(0) {}
  
  dml_vehicle_state(const vnl_vector<double>& p,
