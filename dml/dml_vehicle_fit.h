// This is dml/dml_vehicle_fit.h
#ifndef dml_vehicle_fit_h_
#define dml_vehicle_fit_h_
//=========================================================================
//:
// \file
...
public:
  ...
  bool fit_model_once(dml_pca_vehicle& mesh,
  ...
  double evaluate_residual(const dml_pca_vehicle& mesh,
  ...
  void last_edgel_matches(const dml_pca_vehicle_projector& projector, 
  ...
  void last_edgel_coverage(const dml_pca_vehicle_projector& projector, 
                           const vil_image_view<float>& edge_map,
                           double dist_thresh,
...
protected:
  ...
  virtual double compute_prior(const dml_pca_vehicle& mesh,
                               const vgl_vector_3d<double>& translation,
                               const vgl_rotation_3d<double>& rotation,
                               vnl_matrix<double>& M, 
                               vnl_vector<double>& b);
