// This is dml/dml_pca_vehicle_projector.h
#ifndef dml_pca_vehicle_projector_h_
#define dml_pca_vehicle_projector_h_
//=========================================================================
//:
// \file
...
//   04/27/2009 - Moved from dml_pca_vehicle.h into its own file (mleotta)
// \endverbatim
//=========================================================================
...
class dml_pca_vehicle_projector
{
public:
  //: Constructor
...
private:
  ...
  void map_silhouette(const dml_pca_vehicle& vehicle,
  ...
  void compute_contour_pca_jacobians(const dml_pca_vehicle& vehicle,
  ...
  void compute_parts_pca_jacobians(const dml_pca_vehicle& vehicle,
                                   vcl_vector<vnl_matrix_fixed<double,2,3> >::iterator J);
...
#endif // dml_pca_vehicle_projector_h_
