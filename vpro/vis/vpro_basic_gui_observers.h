// This is vpro/vis/vpro_basic_gui_observers.h
#ifndef vpro_basic_gui_observers_h_
#define vpro_basic_gui_observers_h_
//:
// \file
// \brief  Commonly used vpro_observers that update vgui_tableau
...
class vpro_image_observer: public vpro_observer
{
public:
  vpro_image_observer(const vgui_image_tableau_sptr& itab)
  : image_tab(itab) {}
...
#endif // vpro_basic_gui_observers_h_
