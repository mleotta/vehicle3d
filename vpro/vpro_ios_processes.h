// This is vpro/vpro_ios_processes.h
#ifndef vpro_ios_processes_h_
#define vpro_ios_processes_h_
//--------------------------------------------------------------------------------
//:
// \file
...
template <class T >
class vpro_istream_source : public vpro_source
{
 public:
  vpro_istream_source(const vcl_istream& istream) : is(istream) {}
...
class vpro_ifstream_source_base : public vpro_source
{
  public:
...
template <class T >
class vpro_ifstream_source : public vpro_ifstream_source_base
{
  public:
    vpro_ifstream_source(const vcl_string& filename) { open(filename.c_str()); }
...
template <class T >
class vpro_ifstream_list_source : public vpro_ifstream_source_base
{
  public:
    vpro_ifstream_list_source(const vcl_string& glob) 
    : index(0) { open(glob); }
  
    vpro_ifstream_list_source(const vcl_vector<vcl_string>& files) 
...
template <class T >
class vpro_ostream_sink : public vpro_sink
{
 public:
  vpro_ostream_sink(vcl_ostream& stream) : os(stream) {}
