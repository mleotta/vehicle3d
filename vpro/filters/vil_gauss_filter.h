// This is vpro/filters/vil_gauss_filter.h
#ifndef vil_vpro_gauss_filter_h_
#define vil_vpro_gauss_filter_h_
...
class vil_vpro_gauss_filter : public vpro_filter
{
public:
  //: Constructor
  vil_vpro_gauss_filter(double sigma=1.0, bool reuse_output=true)
...
#endif // vil_vpro_gauss_filter_h_
