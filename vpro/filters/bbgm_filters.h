// This is vpro/filters/bbgm_filters.h
#ifndef bbgm_filters_h_
#define bbgm_filters_h_

//:
// \file
// \brief vpro filters for background modeling
...
class bbgm_update_filter : public vpro_filter
{
public:
...
template <class updater_t, class T>
class bbgm_update_masked_filter : public vpro_filter
{
public:
  typedef typename updater_t::distribution_type dist_t;
...
class bbgm_detect_filter : public vpro_filter
{
public:
...
template <class detector_t, class T>
class bbgm_detect_masked_filter : public vpro_filter
{
public:
  typedef typename detector_t::distribution_type dist_t;
