// This is spl/filters/bbgm_filters.h
...
class bbgm_update_filter : public spl_filter
{
public:
...
template <class updater_t, class T>
class bbgm_update_masked_filter : public spl_filter
{
public:
  typedef typename updater_t::distribution_type dist_t;
...
class bbgm_detect_filter : public spl_filter
{
public:
...
template <class detector_t, class T>
class bbgm_detect_masked_filter : public spl_filter
{
public:
  typedef typename detector_t::distribution_type dist_t;
